...
npm pack @notjustyou/cursor-plugin@0.1.3
tar -xzf notjustyou-cursor-plugin-0.1.3.tgz -C ~/.cursor/plugins/local/notjustyou --strip-components=1
rm notjustyou-cursor-plugin-0.1.3.tgz
```
